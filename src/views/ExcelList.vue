...
const readSheep = (index: number, row: any) => {
  console.log(row, store.detailList)
...
<template>
  ...
  <el-dialog v-model="TableVisible" title="详细信息">
    <el-tabs v-model="activeName">
      <el-tab-pane label="配种记录" name="first">
        <el-table size="small">
      ...
      <el-tab-pane label="采精记录" name="second">Config</el-tab-pane>
      <el-tab-pane label="B超记录" name="third">Role</el-tab-pane>
